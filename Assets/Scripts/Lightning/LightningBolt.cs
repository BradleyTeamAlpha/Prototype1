...
class LightningBolt : MonoBehaviour
{
    ...
    public Vector2 StartV { get { return ActiveLineObj[0].GetComponent<Line>().A; } }
     
    //The position where our bolt ended
    public Vector2 EndV { get { return ActiveLineObj[ActiveLineObj.Count-1].GetComponent<Line>().B; } }
    ...
    {
        Initialize(25);
        ActivateBolt(Vector2.zero, Vector2.up, Tint, 5f);
    }
